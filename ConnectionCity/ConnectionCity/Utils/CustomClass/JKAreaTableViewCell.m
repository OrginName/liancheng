...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        _view_top = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 100, 1)];
        _view_top.backgroundColor = [UIColor orangeColor];
        [self.contentView addSubview:_view_top];
        
        
        _nameText = [[UILabel alloc]initWithFrame:CGRectMake(0, 1, 100, 38)];
        ...
        _view_line = [[UIView alloc] initWithFrame:CGRectMake(0, self.height-1, self.width, 1)];
